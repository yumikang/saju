...
async function migrateHanjaDict() {
  try {
    console.log('Starting hanja_dict migration...');
    
    // SQLite에서 JSON 형태로 데이터 추출
    console.log('Exporting hanja_dict from SQLite...');
    ...
    console.log(`Found ${hanjaDict.length} hanja_dict records`);
