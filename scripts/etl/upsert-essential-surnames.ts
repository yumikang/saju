    ...
    try {
      ...
      if (existing) {
        ...
        const needsUpdate = 
          ...
          JSON.stringify(existing.alternativeReadings || []) !== JSON.stringify(surname.alternativeReadings) ||
          (!existing.element && surname.element) ||
          (!existing.koreanMeaning && surname.koreanMeaning);
        ...
        if (needsUpdate) {
          ...
          await prisma.hanjaDict.update({
            ...
            data: {
              ...
              alternativeReadings: surname.alternativeReadings,
              koreanMeaning: existing.koreanMeaning || surname.koreanMeaning,
          ...
          console.log(`✅ 업데이트: ${surname.character} (${surname.koreanReading}/${surname.alternativeReadings.join('/')})`);
          updated++;
        } else {
        ...
        await prisma.hanjaDict.create({
          data: {
            ...
            koreanReading: surname.koreanReading,
            alternativeReadings: surname.alternativeReadings,
            koreanMeaning: surname.koreanMeaning,
        ...
        console.log(`✨ 생성: ${surname.character} (${surname.koreanReading}/${surname.alternativeReadings.join('/')})`);
        created++;
      }
    } catch (error) {
